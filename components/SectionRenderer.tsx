...
export default function SectionRenderer({ section }: SectionRendererProps) {
  ...
  switch (type) {
    ...
    case 'features':
      return (
        <section style={{ padding: "64px 32px", background: "#141414" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: 32 }}>
              {props.items.map((item: any, i: number) => (
                <div key={i} style={{ textAlign: "center", padding: 24, background: "#242424", borderRadius: 12, boxShadow: "0 2px 8px rgba(0,0,0,0.08)" }}>
          ...
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 32 }}>
              {props.testimonials.map((testimonial: any, i: number) => (
                <div key={i} style={{ background: "#242424", padding: 24, borderRadius: 12, boxShadow: "0 2px 8px rgba(0,0,0,0.08)" }}>
    ...
    case 'footer':
      return (
        <footer style={{ background: "#141414", color: "#fff", padding: "32px" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto" }}>
